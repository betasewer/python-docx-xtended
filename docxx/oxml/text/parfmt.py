...
from docxx.enum.text import (
    WD_ALIGN_PARAGRAPH, WD_LINE_SPACING, WD_TAB_ALIGNMENT, WD_TAB_LEADER
)
from docxx.shared import Length
from docxx.oxml.simpletypes import ST_SignedTwipsMeasure, ST_TwipsMeasure, ST_RelationshipId, ST_String, ST_OnOff
...
class CT_Hyperlink(BaseOxmlElement):    
    ...
    docLocation = OptionalAttribute('w:docLocation', ST_String)
