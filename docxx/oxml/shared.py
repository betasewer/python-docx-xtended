...
"""
Objects shared by modules in the docxx.oxml subpackage.
"""
...
from .ns import qn
from .simpletypes import ST_DecimalNumber, ST_OnOff, ST_String, XsdToken
from .xmlchemy import BaseOxmlElement, OptionalAttribute, RequiredAttribute, ZeroOrMore
