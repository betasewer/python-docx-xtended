...
class _BaseHeaderFooter(BlockItemContainer):
    ...
    @property
    def grid_lines(self):
        return self._sectPr.grid_lines

    @grid_lines.setter
    def grid_lines(self, value):
        self._sectPr.grid_lines = value
        self._sectPr.grid_type = ST_DocGrid.LINES
    
    @property
    def grid_lines_and_chars(self):
        return (self._sectPr.grid_lines, self._sectPr.grid_chars)

    @grid_lines_and_chars.setter
    def grid_lines_and_chars(self, value):
        l, c = value
        self._sectPr.grid_lines = l
        self._sectPr.grid_chars = c
        self._sectPr.grid_type = ST_DocGrid.LINES_AND_CHARS
