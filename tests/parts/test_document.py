...
"""Unit test suite for the docxx.parts.document module"""
...
from docxx.settings import Settings
from docxx.styles.style import BaseStyle
from docxx.styles.styles import Styles
...
class DescribeDocumentPart(object):
    ...
    def FooterPart_(self, request):
        return class_mock(request, 'docxx.parts.document.FooterPart')
    ...
    def HeaderPart_(self, request):
        return class_mock(request, 'docxx.parts.document.HeaderPart')
    ...
    def InlineShapes_(self, request):
        return class_mock(request, 'docxx.parts.document.InlineShapes')

    @pytest.fixture
    def NumberingPart_(self, request):
        return class_mock(request, 'docxx.parts.document.NumberingPart')
    ...
    def SettingsPart_(self, request):
        return class_mock(request, 'docxx.parts.document.SettingsPart')
    ...
    def StylesPart_(self, request):
        return class_mock(request, 'docxx.parts.document.StylesPart')
