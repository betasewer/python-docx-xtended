...
"""Unit test suite for docxx.image package"""
...
from docxx.image.bmp import Bmp
from docxx.image.exceptions import UnrecognizedImageError
from docxx.image.gif import Gif
from docxx.image.image import BaseImageHeader, Image, _ImageHeaderFactory
from docxx.image.jpeg import Exif, Jfif
from docxx.image.png import Png
from docxx.image.tiff import Tiff
from docxx.opc.constants import CONTENT_TYPE as CT
from docxx.shared import Emu, Length
...
class DescribeImage(object):
    ...
    def BytesIO_(self, request, stream_):
        return class_mock(
            request, 'docxx.image.image.BytesIO', return_value=stream_
        )
    ...
    def _ImageHeaderFactory_(self, request, image_header_):
        return function_mock(
            request, 'docxx.image.image._ImageHeaderFactory',
