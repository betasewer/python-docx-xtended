...
from docxx.opc.phys_pkg import _ZipPkgWriter
from docxx.opc.pkgwriter import _ContentTypesItem, PackageWriter
...
class DescribePackageWriter(object):
    ...
    def _ContentTypesItem_(self, request, cti_):
        _ContentTypesItem_ = class_mock(
            request, 'docxx.opc.pkgwriter._ContentTypesItem'
        )
    ...
    def PhysPkgWriter_(self, request):
        _patch = patch('docxx.opc.pkgwriter.PhysPkgWriter')
