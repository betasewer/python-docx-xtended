...
"""
Unit test suite for the docxx.opc.parts.coreprops module
"""
...
from docxx.oxml.coreprops import CT_CoreProperties
...
class DescribeCorePropertiesPart(object):
    ...
    def CoreProperties_(self, request):
        return class_mock(request, 'docxx.opc.parts.coreprops.CoreProperties')
