...
"""
Test suite for docxx.opc.phys_pkg module
"""
...
from docxx.opc.exceptions import PackageNotFoundError
from docxx.opc.packuri import PACKAGE_URI, PackURI
from docxx.opc.phys_pkg import (
...
def tmp_docx_path(tmpdir):
    return str(tmpdir.join('test_python-docxx.docx'))


@pytest.fixture
def ZipFile_(request):
    return class_mock(request, 'docxx.opc.phys_pkg.ZipFile')
