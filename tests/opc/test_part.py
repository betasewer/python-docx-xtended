...
"""Unit test suite for docxx.opc.part module"""

from __future__ import absolute_import, division, print_function, unicode_literals

import pytest

from docxx.opc.package import OpcPackage
from docxx.opc.packuri import PackURI
from docxx.opc.part import Part, PartFactory, XmlPart
from docxx.opc.rel import _Relationship, Relationships
from docxx.oxml.xmlchemy import BaseOxmlElement
...
class DescribePartRelationshipManagementInterface(object):
    ...
    def Relationships_(self, request, rels_):
        return class_mock(
            request, 'docxx.opc.part.Relationships', return_value=rels_
        )
...
class DescribePartFactory(object):
    ...
    def cls_method_fn_(self, request, cls_selector_fn_):
        return function_mock(
            request, 'docxx.opc.part.cls_method_fn',
...
class DescribeXmlPart(object):
    ...
    def parse_xml_(self, request, element_):
        return function_mock(
            request, 'docxx.opc.part.parse_xml', return_value=element_
        )
    ...
    def serialize_part_xml_(self, request):
        return function_mock(
            request, 'docxx.opc.part.serialize_part_xml'
        )
