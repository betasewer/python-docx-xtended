...
"""Unit test suite for docxx.opc.package module"""
...
from docxx.opc.coreprops import CoreProperties
from docxx.opc.package import OpcPackage, Unmarshaller
from docxx.opc.packuri import PACKAGE_URI, PackURI
from docxx.opc.part import Part
from docxx.opc.parts.coreprops import CorePropertiesPart
from docxx.opc.pkgreader import PackageReader
from docxx.opc.rel import _Relationship, Relationships
...
class DescribeOpcPackage(object):
    ...
    def CorePropertiesPart_(self, request):
        return class_mock(request, 'docxx.opc.package.CorePropertiesPart')
    ...
    def PackageReader_(self, request):
        return class_mock(request, 'docxx.opc.package.PackageReader')

    @pytest.fixture
    def PackURI_(self, request):
        return class_mock(request, "docxx.opc.package.PackURI")
    ...
    def PackageWriter_(self, request):
        return class_mock(request, 'docxx.opc.package.PackageWriter')

    @pytest.fixture
    def PartFactory_(self, request):
        return class_mock(request, 'docxx.opc.package.PartFactory')
    ...
    def Relationships_(self, request):
        return class_mock(request, 'docxx.opc.package.Relationships')
    ...
    def Unmarshaller_(self, request):
        return class_mock(request, 'docxx.opc.package.Unmarshaller')
