...
"""
Test suite for the docxx.text.tabstops module, containing the TabStops and
TabStop objects.
"""
...
from docxx.enum.text import WD_TAB_ALIGNMENT, WD_TAB_LEADER
from docxx.shared import Twips
from docxx.text.tabstops import TabStop, TabStops
...
class DescribeTabStops(object):
    ...
    def TabStop_(self, request, tab_stop_):
        return class_mock(
            request, 'docxx.text.tabstops.TabStop', return_value=tab_stop_
        )
