...
"""Unit test suite for the docxx.text.paragraph module"""

from __future__ import absolute_import, division, print_function, unicode_literals

from docxx.enum.style import WD_STYLE_TYPE
from docxx.enum.text import WD_ALIGN_PARAGRAPH
from docxx.oxml.text.paragraph import CT_P
from docxx.oxml.text.run import CT_R
...
class DescribeParagraph(object):
    ...
    def ParagraphFormat_(self, request, paragraph_format_):
        return class_mock(
            request, 'docxx.text.paragraph.ParagraphFormat',
    ...
    def Run_(self, request, runs_):
        run_, run_2_ = runs_
        return class_mock(
            request, 'docxx.text.paragraph.Run', side_effect=[run_, run_2_]
        )
