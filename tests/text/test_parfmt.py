...
"""
Test suite for the docxx.text.parfmt module, containing the ParagraphFormat
object.
"""
...
from docxx.enum.text import WD_ALIGN_PARAGRAPH, WD_LINE_SPACING
from docxx.shared import Pt
from docxx.text.parfmt import ParagraphFormat
from docxx.text.tabstops import TabStops
...
class DescribeParagraphFormat(object):
    ...
    def TabStops_(self, request, tab_stops_):
        return class_mock(
            request, 'docxx.text.parfmt.TabStops', return_value=tab_stops_
        )
