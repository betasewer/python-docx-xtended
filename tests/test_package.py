...
"""Unit test suite for docxx.package module"""

from __future__ import absolute_import, division, print_function, unicode_literals

import pytest

from docxx.image.image import Image
from docxx.opc.packuri import PackURI
from docxx.package import ImageParts, Package
...
class DescribeImageParts(object):
    ...
    def Image_(self, request):
        return class_mock(request, 'docxx.package.Image')
    ...
    def ImagePart_(self, request):
        return class_mock(request, 'docxx.package.ImagePart')
