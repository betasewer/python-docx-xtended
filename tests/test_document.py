...
"""Unit test suite for the docxx.document module"""

from __future__ import absolute_import, division, print_function, unicode_literals

import pytest

from docxx.document import _Body, Document
from docxx.enum.section import WD_SECTION
...
from docxx.section import Section, Sections
from docxx.settings import Settings
from docxx.shape import InlineShape, InlineShapes
from docxx.shared import Length
from docxx.styles.styles import Styles
from docxx.table import Table
...
class DescribeDocument(object):
    ...
    def _Body_(self, request, body_):
        return class_mock(request, 'docxx.document._Body', return_value=body_)
    ...
    def Section_(self, request):
        return class_mock(request, 'docxx.document.Section')
    ...
    def Sections_(self, request):
        return class_mock(request, 'docxx.document.Sections')
