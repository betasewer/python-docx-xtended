...
"""Unit test suite for the docxx.styles.styles module"""
...
from docxx.oxml.styles import CT_Style, CT_Styles
from docxx.styles.latent import LatentStyles
...
class DescribeStyles(object):
    ...
    def LatentStyles_(self, request, latent_styles_):
        return class_mock(
            request, 'docxx.styles.styles.LatentStyles',
    ...
    def StyleFactory_(self, request):
        return function_mock(request, 'docxx.styles.styles.StyleFactory')
