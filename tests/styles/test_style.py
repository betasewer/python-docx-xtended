...
"""
Test suite for the docxx.styles.style module
"""
...
from docxx.styles.style import (
...
class DescribeStyleFactory(object):
    ...
    def _ParagraphStyle_(self, request, paragraph_style_):
        return class_mock(
            request, 'docxx.styles.style._ParagraphStyle',
    ...
    def _CharacterStyle_(self, request, character_style_):
        return class_mock(
            request, 'docxx.styles.style._CharacterStyle',
    ...
    def _TableStyle_(self, request, table_style_):
        return class_mock(
            request, 'docxx.styles.style._TableStyle',
    ...
    def _NumberingStyle_(self, request, numbering_style_):
        return class_mock(
            request, 'docxx.styles.style._NumberingStyle',
...
class Describe_CharacterStyle(object):
    ...
    def Font_(self, request, font_):
        return class_mock(
            request, 'docxx.styles.style.Font', return_value=font_
        )
    ...
    def StyleFactory_(self, request):
        return function_mock(request, 'docxx.styles.style.StyleFactory')
...
class Describe_ParagraphStyle(object):
    ...
    def ParagraphFormat_(self, request, paragraph_format_):
        return class_mock(
            request, 'docxx.styles.style.ParagraphFormat',
